...
//	}
	...
	$("ul.ul_oper_list li").bind('click',function(e){
		...
		if(prevNode!=null && prevNode!=this){
			$("ul.aside_list li:first ul").show();
	...
	*/
	        ...
	        $(".aside_box>ul>li>ul").hide();
	        $(".aside_box>ul>li>ul:first").show();
            $.each($(".aside_box>ul>li>a"), function(){
	            $(this).click(function(){
	               $(".aside_box>ul>li>ul ").not($(this).next()).stop(true,false).slideUp();
